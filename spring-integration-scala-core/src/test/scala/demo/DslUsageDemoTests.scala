...
//    val connectionFactory = JmsDslTestUtils.localConnectionFactory
//    
//    val swiftParser = null//new C24UnmarshallingTransformer
//    
...
//      route.using{. . .}(
//          when("swift"). . .
//             handle.using(swiftParser) -->
//             commonFlow
//          when("fix") . . .
//             handle.using(fixParser) -->
//             commonFlow
//          when("iso20022"). . .
//             handle.using(iso20022Parser) -->
//             commonFlow
//      )
//    
//    val commonFlow = 
//      enrich.using(c24validator) --> // inject some header value based on valid or not
//      route.using{m:Message[C24Object] => xpathExpression agaonst C24Object){
//        when("valid"). . .
//          gemfire.store
//        when("notvlid") {
//           handle// log, write to JMS 
//        } 
//      } 
//    
//    val inboundJmsFlow = 
...
//      
//    val inboundFileFlow = 
//      file.listen(requestDestinationName = "c24Queue", connectionFactory = connectionFactory) -->
//      processingFlow
//      
//      
//      // then after all messages are in Gemfire have a Hadoopor Gemfire  mapreduce thing 
//      
//
////    flow.start
////
