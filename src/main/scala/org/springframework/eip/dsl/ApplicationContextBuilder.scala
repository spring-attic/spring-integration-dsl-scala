...
//            case v:ValueCondition => {
//              val routeToComponent  = v.channelComposition
//              routeToComponent match {
//                case ch:Channel => {
////
...
//                  channelMappings.put(v.value, ch.name)
//                }
//                case _ => {
//                  throw new IllegalArgumentException("Unrecognized component: " + routeToComponent)
...
//              val routeToComponent  = pt.channelComposition
//              routeToComponent match {
//                case ch:Channel => {
